...
cr_age_step2_mods <- readRDS(here("fitted_models/cr_age_step2_mods"))
...
cr_mass_step2_mods <- readRDS(here("fitted_models/cr_mass_step2_mods"))
...
cr_mass_coefCI <- map_df(cr_mass_best_mods$Modnames, get_cr_mass_coefCI_lm) %>%
  ...
  arrange(Delta_AICc) %>% 
  dplyr::select(Modnames, cr.age, growth = weight.slope40, sexM, SEASON1314, Delta_AICc, adj.r2) %>% 
  mutate(Modnames = gsub("_", " + ", Modnames),
         Modnames = gsub("hatch", "hatch date", Modnames),
...
cr_flip_step2_mods <- readRDS(here("fitted_models/cr_flip_step2_mods"))
...
cr_flip_coefCI <- map_df(cr_flip_best_mods$Modnames, get_cr_flip_coefCI_lm) %>%
  ...
  arrange(Delta_AICc) %>% 
  dplyr::select(Modnames, cr.age, growth = flipper.slope40, SEASON1314, Delta_AICc, adj.r2) %>% 
  mutate(Modnames = gsub("_", " + ", Modnames),
         Modnames = gsub("hatch", "hatch date", Modnames),
...
cr_tib_step2_mods <- readRDS(here("fitted_models/cr_tib_step2_mods"))
...
cr_tib_coefCI <- map_df(cr_tib_best_mods$Modnames, get_cr_tib_coefCI_lm) %>%
  ...
  arrange(Delta_AICc) %>% 
  dplyr::select(Modnames, cr.age, growth = tibiotar.slope35, SEASON1314, Delta_AICc, adj.r2) %>% 
  mutate(Modnames = gsub("_", " + ", Modnames),
         Modnames = gsub("hatch", "hatch date", Modnames),
...
cr_size_out_table <- rbind(
  # mass rows
  data.frame(Modnames = "Competetive creching mass model", cr.age = "", growth = "", sexM = "", SEASON1314 = "", Delta_AICc = "", adj.r2 = ""),
  cr_mass_coefCI,
  ...
  # flipper rows
  data.frame(Modnames = "Competetive creching flipper length model", cr.age = "", growth = "", sexM = "", SEASON1314 = "", Delta_AICc = "", adj.r2 = ""),
  cr_flip_coefCI %>% mutate(sexM = NA),
  data.frame(Modnames = paste("next best model \u0394 AICc = ", cr_mass_next_best$Delta_AICc[[1]]), cr.age = "", growth = "", sexM = "", SEASON1314 = "", Delta_AICc = "", adj.r2 = ""),
    # tib rows
    data.frame(Modnames = "Competetive creching tibiotarsus length models", cr.age = "", growth = "", sexM = "", SEASON1314 = "", Delta_AICc = "", adj.r2 = ""),
